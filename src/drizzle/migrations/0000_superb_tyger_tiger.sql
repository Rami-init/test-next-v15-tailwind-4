CREATE TYPE "public"."course_section_status" AS ENUM('public', 'private', 'preview');--> statement-breakpoint
...
ALTER TABLE "lesson" ADD CONSTRAINT "lesson_sectionId_courses_id_fk" FOREIGN KEY ("sectionId") REFERENCES "public"."courses"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
